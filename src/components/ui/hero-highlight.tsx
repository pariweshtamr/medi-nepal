...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-blue-500/90 to-blue-400/90 dark:from-blue-900/50 dark:to-blue-900/70 px-2 py-1 border-blue-700/30`,
        className
      )}
    >
      {children}
